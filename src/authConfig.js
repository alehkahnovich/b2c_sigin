...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://icy-river-0e71bd71e.1.azurestaticapps.net/redirect', // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
